...
<div class="easyui-layout" style="width:100%; height:800px;">  
    ...
    <div data-options="region:'center',title:'Employee Information',iconCls:'icon-ok'"> 
        ...
        <form class="form" id="emCareerNew" action="employee_career_save.php?mode=new" method="POST" >
                ...
                <table class="ui-state-default">
                    <tbody>
                        <tr>
                            ...
                            <td width="250"><input type="text" name="ORGANIZATION_NAME" value=""></td>
                            <td width="150">Designation:</td>
                            <td width="250"><?php combobox("DESIGNATION_ID", $designationList, '', true); ?></td>
                        </tr>
                        <tr class="fitem">
                            <td >Year Of Experience:</td> 
                            <td><input type="text" name="YEAR_OF_EXPERIENCE" value=""></td>
                            <td>Career Start Date:</td>
                            <td><input name="CAREER_START_DATE" class="easyui-datebox" value="" /></td>
                        </tr>
                        <tr class="fitem">
                            <td >Career End Date:</td> 
                            <td><input name="CAREER_END_DATE" class="easyui-datebox" value="" /></td>
                            <td>Status:</td>
                            <td><?php combobox("STATUS", $statusList,'', true); ?></td>
                        </tr>
                    </tbody>
                </table>
