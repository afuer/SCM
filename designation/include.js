...
function loadGrid() {
    ...
    $('#dataGrid').datagrid({
                ...
                
        {
            ...
            title: 'Designation Nmae'
        },

        {
            field: 'PRODUCT_APPROVAL', 
        ...
        {
            field: 'DESIGNATION_SORT', 
            title: 'Designation Sort'
        }
        ]]
...
function Edit() {
    ...
    if (row) {
        ...
        $('#fm').form('load', row);
        url = 'save.php?mode=""&search_id=' + row.DESIGNATION_ID;
    }
}
function Save() {
    //alert(22);
