    ...
    <div data-options="region:'center'" Title='Product List' style="padding: 10px 10px; background-color:white; "> 
        ...
        <form action="add_suppliers2.php" method='GET' autocomplete="off" class="formValidate">
            <table class="ui-state-default">
                ...
                <th field="name2"  width="80">Req.ID</th>
                <th field="name3">Requisition From</th>
                <th field="name4" width="100">Branch/Dept</th>
                <th field="name11" width="150">Product Name</th>
                    ...
                    foreach ($req_id as $key => $value) {
                        ...
                        while ($rec = fetch_object($sql_result)) {
                            ...
                            <tr>
                                ...
                                <td align="center"><input type="text" name="qty[<?php echo $rec->PRODUCT_ID; ?>][<?php echo $rec->REQUISITION_ID; ?>]" value="<?php echo $rec->quantities - $rec->CS_QTY; ?>" min="1" style="width: 70px;"/></td>
