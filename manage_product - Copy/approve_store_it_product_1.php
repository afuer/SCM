...
$sqlMain = "SELECT si.PRODUCT_ID,
        ...
        WHERE si.PROCESS_DEPT_ID='$ProcessDeptId'
        AND si.DETAILS_STATUS=15 AND si.STATUS_APP_LEVEL=3
...
<div style="background-color:white; padding: 20px 20px; "> 
    ...
    <form name="frm" action="" method='POST' autocomplete="off" class="formValidate">
        ...
        <input type="submit" class="button" value='Submit' name='save' id="approved" />
