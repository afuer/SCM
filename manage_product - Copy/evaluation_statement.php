    ...
    <div data-options="region:'center'" Title='Comparative Statement Details' style="padding: 10px 10px; background-color:white; "> 
        ...
        <form action="" method="post">
            ...
            <table width="<?php echo $width; ?>px"  class="ui-state-default">
                ...
                <?php
                $cs_sql = "SELECT p.PRODUCT_NAME, ut.UNIT_TYPE_NAME, pcd.productid 
                ...
                while ($rec_s = fetch_object($query_s)) {
                    ...
                    <tr style="background-color:#D5D5AA">
                        ...
                        <?php
                        $total_vale = 0;
                        $sql2 = "SELECT com.selected, com.unite_price,
                            IFNULL(com.unite_price,0)*IFNULL(com.quantity,0) as total, quantity AS 'quantity'

                            FROM price_comparison_details com
                            WHERE com.comparison_id='$comparison_id' and productid='$rec_s->productid' 
                        ...
                        while ($rec_price = fetch_object($sql_query)) {
                            ...
                            <td align=right  <?php echo $bgcolor; ?>><span class="none"><?php echo $rec_price->quantity; ?></span></td>
            ...
            <table class="table" style="width: 800px;">
                <tr>
                    <td><h1>Committee Info</h1></td>
                    <td align="right"><a href="evaluation_committee.php?compersionid=<?php echo $comparison_id; ?>" target="_blank" class="button"<span class = "icon plus"></span>Add/ Edit Committee Info</a></td>
                </tr>
            </table>
            <table class="ui-state-default">
                ...
                <tr>
                    ...
                    <td colspan="3"><?php echo $recommendation; ?></td>
                </tr>
            </table>
            <br/>
            <table class="table" style="width: 800px;">
                ...
                <tr>
                    <td colspan="2" align="left"><?php echo $recommendation; ?></td>
                </tr>
            </table>
            <br/>
            ...
            if ($rec_com->status == 1) {
                ?>
                <input type="submit" value='Create Approval Note Step-1' name='save' id="approved" />
