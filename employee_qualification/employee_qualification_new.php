...
<div class="easyui-layout" style="width:100%; height:800px;">  
    ...
    <div data-options="region:'center',title:'Employee Information',iconCls:'icon-ok'"> 
        ...
        <form class="form" id="emCareerNew" action="employee_qualification_save.php?mode=new" method="POST" >
                ...
                <table class="ui-state-default">
                    <tbody>
                        <tr>
                            ...
                            <td width="250"><input  type="text" name="QUALIFICATION_AREA" value=""/></td>
                            <td width="150">Qualification Title:</td>
                            <td width="250"><input  type="text" name="QUALIFICATION_TITLE" value=""/></td>
                        </tr>
                        <tr>
                            <td >Institute:</td> 
                            <td><input  type="text" name="INSTITUTE" value=""/></td>
                            <td>Result:</td>
                            <td><input  type="text" name="RESULT" value=""/> </td>
                        </tr>
                        <tr class="fitem">
                            <td >Start Date:</td> 
                            <td><input name="START_DATE" class="easyui-datebox" value="" /></td>
                            <td>End Date:</td>
                            <td><input name="END_DATE" class="easyui-datebox" value="" /></td>
                        </tr>
                    </tbody>
                </table>
