...
<div class="panel-header">Delivery Products</div>
<div style="padding: 20px 10px; background-color:white; ">  


    <form>
        <table width="800" border="0" cellspacing="1" cellpadding="2" id="hor-minimalist-b" bgcolor="#FFFFFF">
            <tr>
                <td width="70%" valign="top"><img src="../public/images/CityBank.png" height="40"/></td>
                <td width="30%" valign="top"><b>The City Bank</b><br /> 136, Gulshan Avenue, Gulshan-2, <br />Dhaka-1212, Bangladesh<br />Web: www.thecitybank.com</td>
            </tr>
        </table>
        <fieldset>
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td colspan="3" valign="top"><?php echo $rec->REMARK; ?></td>
                </tr>
            ...
            <table>
                <tr>
                    ...
                    $requisition_process_history = $db->query("SELECT wm.EMPLOYEE_ID,
