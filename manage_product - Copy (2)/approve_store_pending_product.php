        ...
        <div  title="Product List"> 
            ...
            <form name="frm" action="" method='POST'>
                ...
                <table class="ui-state-default">
                    <thead>
                    <th>Sl.</th>
                    <th width="52" align="center">Chk</th>
                    ...
                    while ($rec = fetch_object($sql)) {
                        ...
                        <tr>
                            ...
                            <?php if ($ProcessDeptId == 2) { ?>
                                <td><input type="text" name="help_desk[<?php echo $rec->REQUISITION_ID; ?>]"/></td>
                                <td><input type="text" name="ref_date[<?php echo $rec->REQUISITION_ID; ?>]" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser"/></td>
                                <td><input type="text" name="bill_no[<?php echo $rec->REQUISITION_ID; ?>]"/></td>
                                <td><?php comboBox("supplier_id[$rec->REQUISITION_ID]", $supplier_list, '', TRUE); ?></td>
                                <td><?php comboBox('sol', $solList, '', TRUE, 'required'); ?></td>
                                <td><?php comboBox("cost_center_id[$rec->REQUISITION_ID]", $costCenterList, '', TRUE); ?></td>
                            <?php } ?>
