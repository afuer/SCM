...
$gridSQL = "SELECT vat_11_id, '' AS sl,
	cb_no,
	transaction_date, 
	ga.GL_ACCOUNT_ID,
	ga.GL_ACCOUNT_NAME,
	sol, s.SOL_NAME, s.SOL_CODE,
	bill_amount,
	vat_amount,
	mushak_amount
        FROM vat_11 v
...
<div class="panel-header">Vat List</div>
<div style="padding: 20px 20px; background: white;">
    ...
    <!--<a href="vat_11.php" class="button">Add New</a>-->
    <a href="vat_11.php" class="button" iconCls="icon-add" plain="true">Add New</a>
    ...
    <table id="resultTable" class="ui-state-default">
        ...
        <tbody>
            ...
            while ($resultObj = fetch_object($resultQuery)) {
                ...
                $totRebateAmount+=$resultObj->mushak_amount;
                ?>
                <tr>  
                    <td><?php echo++$sl; ?></td>
                    ...
                    <td align="right"><?php echo formatMoney($resultObj->mushak_amount); ?></td>
                    <td><?php viewIcon("vat_11_view.php?searchId=$resultObj->vat_11_id"); ?></td>
                    <td><?php editIcon("vat_11.php?mode=edit&searchId=$resultObj->vat_11_id"); ?></td>
                    <td><?php deleteIcon("vat_11.php?mode=delete&searchId=$resultObj->vat_11_id"); ?></td>
