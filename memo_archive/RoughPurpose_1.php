                    ...
                    <form method="post" enctype="multipart/form-data" id="fm" novalidate autocomplete="off">
                        <table class="table">
                            ...
                            <tr class='fitem'>                        
                                ...
                                <td><input type="text" name="MEMO_SUBJECT" class="easyui-validatebox" data-options="required:true" size="50" /></td>
                            </tr>
                            <tr>   
                                <td>Memo Info Ref</td>
                                <td>
                                    <table id="a" class="ui-state-default">
                                        <thead>
                                        <th width="5">SL</th>    
                                        <th width="50">Memo Info Ref</th>
