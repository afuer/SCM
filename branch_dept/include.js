...
function loadGrid() {
    ...
    $('#dataGrid').datagrid({
        ...
        url: 'get.php',
        columns: [[
                {field: 'BRANCH_DEPT_NAME', title: 'Branch Name'},
                {field: 'OFFICE_NAME', title: 'Office Type'},
                {field: 'ADDRESS', title: 'Branch Address'},
                {field: 'BRANCH_DEPT_NAME_ROUTE', title: 'Branch Route'},
                {field: 'BRANCH_DEPT_NAME_SORT', title: 'Branch Sort'},
                {field: 'BRANCH_DEPT_NAME_CODE', title: 'Branch Code'}
            ]]
...
function Edit() {
    ...
    if (row) {
        ...
        $('#fm').form('load', row);
        url = 'save.php?mode=""&search_id=' + row.BRANCH_DEPT_ID;
    }
}
function Save() {
//alert(22);
