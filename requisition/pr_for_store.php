...
$uploader->AllowedFileExtensions = "jpeg,jpg,gif,png,zip, png";
...
<script src="pr_for_store.js" type="text/javascript" ></script>
            ...
            <fieldset class="fieldset" style="width: 780px;"> 
                ...
                <table>
                    <tr>
                        ...
                        <td><textarea name="specification" style="width: 200px;"></textarea></td>
                        <td valign="top">Justification:</td>
                        <td><textarea name="justification" style="width: 200px;"></textarea></td>       
                    </tr>
                    <tr>
