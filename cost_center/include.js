...
function loadGrid() {
    ...
    $('#dataGrid').datagrid({
        ...
        url: 'get.php',
        columns: [[
                {field: 'COST_CENTER_CODE', title: 'Cost Center Code'},
                {field: 'COST_CENTER_NAME', title: 'Cost Center Name'}
            ]]
...
function Edit() {
    ...
    if (row) {
        ...
        $('#fm').form('load', row);
        url = 'save.php?mode=""&search_id=' + row.COST_CENTER_ID;
    }
}
function Save() {
//alert(22);
