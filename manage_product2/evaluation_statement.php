...
if (isset($approved) || isset($save) || isset($cancell)) {
    ...
    if (isset($save)) {
        ...
        echo "<script type='text/javascript'>window.location = 'evaluations.php'</script>";
    ...
    <div data-options="region:'center'" Title='Comparative Statement Details' style="padding: 10px 10px; background-color:white; "> 
        ...
        <form action="" method="post">
            ...
            <table width="<?php echo $width; ?>px" class="table">
                ...
                <tr>
                    <td align="center" class="title">Prime Bank Limited </td>
                </tr>
                <tr>
                ...
                while ($rec_s = fetch_object($query_s)) {
                    ...
                    <tr style="background-color:#D5D5AA">
                        ...
                        $sql2 = "SELECT com.selected, com.unite_price,
                            IFNULL(com.unite_price,0)*IFNULL(com.quantity,0) as total,
                            (
                            SELECT SUM(cs_qty) 
                            FROM price_comparison_pro_req_qty 
                            WHERE product_id='$rec_s->productid' AND price_comparison_id='$comparison_id'
                            ) AS 'quantity'
            ...
            if ($rec_com->status == 1) {
                ?>
                <input type="submit" value='Recommended' name='save' id="approved" />
