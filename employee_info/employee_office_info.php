...
$var = $employee_personal->getDataOfficeInfo($employeeId);
$EMPLOYEE_ID = $var->LINE_MANAGER_ID;
$lineManager = $employee_personal->supervisorHeading($EMPLOYEE_ID);
$RELIEVER_EMP_ID = $var->RELIEVER_EMP_ID;
$reliever = $employee_personal->supervisorHeading($RELIEVER_EMP_ID);
?>
...
<a class="button" id="employeePersonal" href="#" onclick="editEmployeeOfficeInfo()"  > Modify</a>
