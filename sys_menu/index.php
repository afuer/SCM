...
$columnsData = "{field: 'MENU_NAME', title: 'Menu Name'},
   {field: 'UNDER', title: 'Under Menu'},
    {field: 'LINKS', title: 'URL'},
   {field: 'Status', title: 'Active'}";
...
<div id="toolbar" style="padding:5px;height:auto">  
    <div id="toolbar">
        <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newUser()">Add Menu</a>
