...
<div class="easyui-layout" style="width:950px; margin: auto; height:600px;">  
    <div data-options="region:'center'" Title='Delivery Products' style="padding: 10px 10px; background-color:white; "> 
        ...
        <fieldset>
            ...
            <table class="table">
                <tr>
                    <td><img src="../public/images/CityBank.png" height="40"/></td>
                    <td></td>
                    <td></td>
                    <td align="right"><span class="style1">The City Bank Ltd.</span><br />
                        Dead Stock and Stationery Dept<br />
                        <span class="style2">Head Office</span><br />
                        407, Tejgaon 1/A, Dhaka-1208 
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><div align="left">Challan No : <font color="#008000"><?php echo $data->challan_no; ?></font></td>
                    <td></td>
                    <td></td>
                    <td>PR No: <a href="../manage_product/reco_details.php?reco_id=<?php echo $requisition; ?>" target="_blank"><?php echo $requisition; ?></a></td>
                </tr>
                <tr>
                    <td align="left">Address: <font color="#008000"><?php echo $emp_deta->address; ?></font></td>
                    <td></td>
                    <td></td>
                    <td></td>
                </tr>
