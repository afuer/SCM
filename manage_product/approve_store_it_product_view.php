...
$sql_produc_list = "SELECT si.PRODUCT_ID,
        ...
        AND si.DETAILS_STATUS=2 AND si.STATUS_APP_LEVEL=1
...
<div style="background-color:white; padding: 20px 20px; "> 
    ...
    <form name="frm" action="" method='POST' autocomplete="off" class="formValidate">
        ...
        <input type="submit" class="button" value='Confirm' name='approved' />
        <!--<input type="submit" class="button" value='Edit' name='cancle' />-->
